...
public class GenericsDemo2
{
    public static void main( String args[] )
    {
        ...
        //basket.add(new Some()); ///<----- type mismatch cannot add Some to type  Basket<PerishableItem>
        basket.show();
        
        Basket<Fruit> fruitBasket = new Basket<Fruit>();
        
       // basket = fruitBasket;     //<----- type mismatch cannot convert basket from type PerishableItem to Fruit
    } 
}
